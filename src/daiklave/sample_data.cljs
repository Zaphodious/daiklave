  ...
  {:home       {:app-home true
   ...
   :characters {:name        "Characters"
                ...
                "424242"     {:name                 "Rajmael",
                              ...
                              :held-weapon          {:name "Short Sword", :as "Katana", :category :mundane-weapons}
                              :weapon-inventory     [{:name "Short Sword", :as "Katana", :category :mundane-weapons}
                ...
                "963963963"  {:name                 "Alkaia",
                              ...
                              :specialties          [[:sail "Captiancy"]
                                                     ...
                                                     [:larceny "Lockpicking"]]
                              :merits               []
                              :held-weapon          {:name "Great Sword", :category :mundane-weapons}
                              :weapon-inventory     [{:name "Great Sword", :category :mundane-weapons}
                                                     {:name "Unarmed", :category :mundane-weapons}]
                ...
                "7777777777" {:name                 "Lin Fang",
                              ...
                              :held-weapon          {:name "Knife", :as "Fang of Fate", :category :mundane-weapons}
                              :weapon-inventory     [{:name "Knife", :as "Fang of Fate", :category :mundane-weapons}
                                                     {:name "Unarmed", :category :mundane-weapons}]
                ...
                "789789789"  {:name                 "Daesh",
                              ...
                              :weapon-inventory     [{:name "Lance", :category :mundane-weapons}
                                                     {:name "Unarmed", :category :mundane-weapons}]
