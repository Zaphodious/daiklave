...
(def bureaucracy-charms [{:description "With a cursory examination, the Lawgiver can determine the exact quality of any good oﬀered for sale. She can tell if it is in poor, average, or excellent condition. However, this grants her no knowledge of the market value of any particular good, nor does it tell her the purpose of an object. By inspecting a scavenged mechanism of the First Age, she could tell if it was functional, but not how it functions.",
                         ...
                         {:description "Through use of this Charm, the Solar gains an intuitive feel for a marketplace at a given instant, allowing her to intuit roughly how much a given object will fetch in any one market. Though the Exalt need not be physically present in the market, this Charm must be used with a particular sales venue in mind. The Solar cannot discover previously unknown markets through use of this Charm. She can, however, review distant markets to determine which would be the best to sell a good. The more specific the venue contemplated, the more accurate the forecast. A Solar using this technique can make a perfectly accurate assessment at the moment of sale, but the longer she waits between using this Charm and the actual sale of the goods, the larger her margin for error, as economies shift with time.",
                          :prereq-charms "Frugal Merchant Method",
                          :ability :bureaucracy,
                         ...
                         {:description "The Lawgiver can evaluate a buyer’s intention and budget with a glance. This enacts a ([Perception or Wits] + Bureaucracy) read intentions action against the target’s Guile. If successful, the Exalt can tell if the target plans to betray or cheat her. If he does, the Solar’s Resolve is raised by her Essence against all bargain action attempts by that character. She may also use this Charm to determine a character’s Resources rating and whether he intend to buy or whether he needs to be swayed into attempting a bargain action.",
                          ...
                          :character-tags [],
                          :min-essence 1}
                         {:description "Through use of this Charm the Solar broadcasts her ability  to evaluate and fence any good, and to estimate the viability of any good or service in any market. This Charm makes  characters naturally assume the Solar is a master merchant,  someone who should be approached in order to receive  the best deal or gain information about any certain product.  This Charm does not confer knowledge of any good the  Solar is unfamiliar with, but it does allow her to reﬂexively employ Insightful Buyer Technique for one mote, in  order to speculate on the value of goods in local or foreign  markets, even those that may not be physically present.",
                          :prereq-charms "Consumer-Evaluating Glance",
                          :ability :bureaucracy,
                         ...
                         {:description "By spending a day in a market, the Lawgiver can sense the  ebb and ﬂow of commerce, guiding her to knowledge of  hidden or illegal markets. By observing normal transactions, speaking with merchants and customers, and watching the general course of economic dalliance, she becomes  aware of the bureaucratic specialties of everyone connected to a specifc market. The Lawgiver even becomes aware  of the special market knowledge of characters whose names  she doesn’t know and whose faces she has never seen.",
                          ...
                          :character-tags [],
                          :min-essence 1}
                         {:description "The Lawgiver becomes preternaturally adept at navigating through bureaucracies. She can naturally sense who  to talk to in order to produce results, who expects or is  amenable to bribes, which functionaries are actually useful  or friendly and which are ofcious tyrants abusing their  meager sliver of power. The Solar may add her Bureaucracy score to the read intentions actions of any Ability  so long as it helps her in producing a desired bureaucratic result, such as obtaining a license, gaining a passport  or securing an audience.",
                          :prereq-charms "None",
                          :ability :bureaucracy,
                         ...
                         {:description "The Solar can sum up the member of an organization with  perfect incision. This Charm creates a ([Social or Mental Attribute] + Bureaucracy) read intentions action adding  the Solar’s Essence in automatic successes. This Charm  is automatically successful unless resisted with magic,  and cannot be resisted by characters whose temporary  Willpower is currently lower than the Solar’s. Upon  reading her subject, the Exalt can determine the exact  strongest or most relevant Intimacy he holds for the organization in question.",
                          :prereq-charms "Deft Ofcial’s Way",
                          :ability :bureaucracy,
                          ...
                          :character-tags [],
                          :min-essence 1}
                         {:description "The Exalt can govern an organization with preternatural  awareness. With this Charm, the Lawgiver is made aware  when the member of an organization has his Intimacy for  the organization challenged by any kind of social inﬂuence  that does not involve the Psyche keyword. This awareness  is contingent on the Solar having used read intentions  actions to uncover the relevant Intimacies of the character in question. The Solar’s awareness extends to the  moment the character’s Intimacy is challenged if and only  if the character is currently functioning in some capacity  for the organization. If the subject is not presently working  for the Solar, she only notices that someone has attempted  to inﬂuence him when he returns to his role or functions  as a member of the organization. This clarifcation applies  to current as well as former members—the Exalt only immediately notices inﬂuence against a character who is currently on duty. This Charm does not convey any knowledge  of the substance of such social inﬂuence, or whether it was  successful—only that it happened.",
                          :prereq-charms "Measuring Glance",
                          :ability :bureaucracy,
                         ...
                         {:description "The Solar may use her bureaucratic prowess to reform an ailing or corrupt bureaucracy. The Lawgiver must participate in an investigation of the organization, attending or leading inquiries, reviewing records and interviewing involved parties. For the duration of the inquest, add the Solar’s Bureaucracy in automatic successes to her Investigation and Socialize rolls to conduct this investigation. In addition, while this Charm is in eﬀect, members of the organization will automatically perceive the Solar as a subject of confdential trust with regards to the bureau— someone they should both confde in and should speak truthfully to. This registers as a Major Intimacy with most, but those with strong will and reasons to want to hide the truth will clock in with no more than a Minor Intimacy of respect for the Lawgiver’s authority.",
                          :prereq-charms "Speed the Wheels",
                          :ability :bureaucracy,
                         ...
                         {:description "The Exalt’s understanding of business language and commerce makes her seem worldly and wise. Add half her Bureaucracy score (rounded up) in dice to all social inﬂuence to aﬀect bargains, trade, create business partnerships, create good will between organizations, communicate effective orders, mediate, and so on.",
                          :prereq-charms "Deft Ofcial’s Way, Frugal Merchant Method",
                          :ability :bureaucracy,
                          ...
                          :character-tags [],
                          :min-essence 1}
                         {:description "This Charm depicts a Solar who is an irresistible high pressure salesman. This Charm supplements a bargain action with double 7s. If the Exalt’s bargain is successful, she gains a point of temporary Willpower.",
                          :prereq-charms "Consumer-Evaluating Glance,",
                          :ability :bureaucracy,
                         ...
                         {:description "Once a day, the Solar gains a point of temporary Willpower for succeeding at a bargain action.",
                          :prereq-charms "Irresistible Salesman Spirit",
                          :ability :bureaucracy,
                         ...
                         {:description "The Solar becomes fused with her organization at the unconscious level. Her Essence ﬂows through all aspects of her bureaucracy, subtly altering her existence as she alters it in turn. If the Exalt has captured magic using WoeCapturing Web, this Charm allows her to discover profling information among her immaculately-kept paperwork, revealing the identity of the one whose magic has been snared.",
                          :prereq-charms "Woe-Capturing Web",
                          :ability :bureaucracy,
                         ...
                         {:description "The Lawgiver can arrest an entire arm of government with one deft stroke. The Solar targets a project she’s aware of and dooms it with a ﬂash of her Caste Mark. Roll ([Cha risma or Manipulation] + Bureaucracy) against the Bu reaucracy, Investigation, Larceny or War (whichever is applicable to the project) of each character responsible for leading the project. For each success, that character will experience (Solar’s Essence) botches trying to carry out that project. As failure manifests, the frst result is that communication breaks down, becoming hostile, ineﬀec tive, or completely impossible (as with the collapse of the information arm of a military establishment). A project that is a monumental failure may threaten the stability of an entire organization. This Charm may not be used on a single organization more than once per season.",
                          ...
                          :character-tags [],
                          :min-essence 3}
                         {:description "The Solar’s understanding of bureaucratic procedure is immense and complex. She may draw on this well of knowl edge to enact a free full Bureaucracy Excellency once per season. This Charm can be reset by the Solar aiding in the success of a particularly difcult project (see p. 225) as determined by the Storyteller.",
                          :prereq-charms "Semantic Argument Technique",
                          :ability :bureaucracy,
                         ...
                         {:description "As long as the Lawgiver’s organization has succeeded at one challenging project in the previous season, her bureaucracy automatically completes one project within its scope without ever undertaking it. Once per story, the Exalt may travel to an isolated section of her business headquarters where she will fnd the proof of a completed task. She might fnd useful tools, resources, deeds, valuable paperwork, and so forth. The Storyteller should select items which will prove of some use to the Solar each time she decides to invoke this Charm. The more powerful her organization, the better the discovered spoils will be. Note that use of this Charm does not itself count as completion of a challenging project.",
                          :prereq-charms "Omen-Spawning Beast",
                          :ability :bureaucracy,
                         ...
                         {:description "The Lawgiver may pass down laws to her agents which are sacrosanct. The Solar repeatedly inveighs against a certain action, making it anathema. It then becomes impossible for members of her organization to carry out that action—but only in the context of functions of the bureaucracy. Furthermore, the Solar must be specifc in citing those behaviors which are banned. Thus, she could not ban all theft, but she could ban “Theft from the company coﬀers” or “Embezzlement of client capital.” Likewise, while these bans would prevent members of her organization from stealing from her organization, they do not prevent those members from committing such crimes outside the jurisdiction of her organization. Characters aﬀected by this Charm can treat any social inﬂuence to break a defned taboo as an unacceptable one. The Solar may stack this Charm (Essence) times to protect her organization thusly.",
                          :prereq-charms "Foul Air of Argument Technique",
                          :ability :bureaucracy,
                         ...
                         {:description "The Solar’s eﬀective delegation of power bolsters the might of Creation. To use this Charm, the Solar must confer advice to a bureaucracy either directly or through mediators (letters, messengers, etc.). The Lawgiver proposes bureaucratic reforms and operating sequences that are efcacious and skillful: roll (Charisma + Bureaucracy) against a difculty of 5. If successful, the organization’s leaders gain a number of non-Charm dice equal to the roll’s extra successes. These dice can be used on (Solar’s Essence) Bureaucracy, Investigation, Larceny, Lore, Medicine or War rolls dealing with running a relevant organization or project. The Solar may enhance her own actions with this Charm, and if she or any other Solar is a benefciary of this eﬀect, the organization becomes a “Creational bulwark” on the spot. The Wyld cannot penetrate its territories, diseases struggle to cross its borders, and Shadowlands encroach upon it more slowly. This eﬀect lasts one week.",
                          ...
                          :keywords "None",
                          :min-ability 5,
                          :are-efcacious-and-skillful "roll (Charisma + Bureaucracy)",
                          :cost "10m, 1wp",
                          :character-tags [],
                          :min-essence 5}])
